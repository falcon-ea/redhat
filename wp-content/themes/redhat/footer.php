  ...
  <div class="container">
    <div class="footer__inner">
      ...
      <div class="footer__info"> 
        <div class="footer__info-sert"><?php the_field('footer_info-sert', 'options');?></div><a class="footer__info-conf" href="<?php the_field('footer_info-conf', 'options');?>">Политика конфиденциальности</a>
      </div>
      <div class="footer__soc"><a class="footer__soc-icon footer__soc-icon_inst" href="<?php the_field('footer_soc-icon_inst', 'options');?>"></a><a class="footer__soc-icon footer__soc-icon_vk" href="<?php the_field('footer_soc-icon_vk', 'options');?>"></a></div>
      ...
      </div><a class="btn footer__btn" href="#"> <span><?php the_field('footer_btn', 'options');?></span></a><a class="footer__info-conf footer__info-conf_mobile" href="<?php the_field('footer_info-conf', 'options');?>">Политика конфиденциальности</a>
    </div>
  </div>
</footer>
