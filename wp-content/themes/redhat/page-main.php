...
<section class="banner">
  <div class="container">
    <div class="banner__inner">
      <h1 class="banner__title"><?php the_field('banner_title', 'options'); ?></h1>
      <div class="banner__subtitle"><?php the_field('banner_subtitle', 'options'); ?></div>
      <div class="banner__items">
        <div class="banner__item">
          <div class="banner__item-img banner__item-img_bg1"></div>
          <div class="banner__item-text"><?php the_field('banner_item-text_1', 'options'); ?></div>
        </div>
        <div class="banner__item">
          <div class="banner__item-img banner__item-img_bg2"></div>
          <div class="banner__item-text"><?php the_field('banner_item-text_2', 'options'); ?></div>
        </div>
      </div>
      <div class="banner__buttons"><a class="btn banner__btn" href="#"><span><?php the_field('banner_btn', 'options'); ?></span></a>
        <div class="banner__desc"><?php the_field('banner_desc', 'options'); ?></div>
      </div><a class="banner__scroll" href="#result">
        <div class="banner__scroll-img"></div>
        <div class="banner__scroll-text"><?php the_field('banner_scroll-text', 'options'); ?></div></a>
    </div>
